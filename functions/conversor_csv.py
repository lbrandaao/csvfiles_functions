...
#Necessário aprimorar para o caso de dados separados por strings diferentes de ',' ou ';' e com números decimais com ','. E também para o caso em que deseja trocar a codificação (passar para bytes).
